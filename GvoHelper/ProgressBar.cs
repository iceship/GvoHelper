	...
	public class ProgressBar : System.Windows.Forms.UserControl 
	{
		...
		#region -  Drawing  -
			...
			private void DrawBar(Graphics g)
			{
                ...
                g.DrawString(this.Value.ToString() , SystemFonts.DefaultFont, Brushes.Black,
                    new PointF(this.Width / 2.0F - (this.CreateGraphics().MeasureString(this.Value.ToString(),
                        SystemFonts.DefaultFont).Width / 2.0F), 1));
                /*
                int percent = (int)(((double)this.Value / (double)this.MaxValue) * 100);
                using (Graphics gr = this.CreateGraphics())
                {
                    gr.DrawString(
                        ...
                        Brushes.Black,
                        new PointF(this.Width / 2 - (gr.MeasureString(percent.ToString() + "%",
                        SystemFonts.DefaultFont).Width / 2.0F),
                        this.Height / 2 - (gr.MeasureString(percent.ToString() + "%",
			...
			{
                Rectangle tr = new Rectangle(1, 1, this.Width - 1, this.Height / 3);
                ...
                Rectangle br = new Rectangle(1, this.Height - 8, this.Width - 1, this.Height / 3);
